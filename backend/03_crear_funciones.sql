...
-- Limpiar funciones previas para evitar conflictos de firmas/retorno
DROP FUNCTION IF EXISTS ven_AnalisisVenta(INTEGER, SMALLINT) CASCADE;
DROP FUNCTION IF EXISTS Ven_GeneraKardex(CHAR(4)) CASCADE;
DROP FUNCTION IF EXISTS Ven_GeneraKardex(CHARACTER) CASCADE;
DROP FUNCTION IF EXISTS Ven_GenerarCronograma(CHAR(9), CHAR(1), SMALLINT) CASCADE;
DROP FUNCTION IF EXISTS ven_Indicador_Venta(INTEGER) CASCADE;
DROP FUNCTION IF EXISTS ven_Indicador_Venta_P(INTEGER) CASCADE;
DROP FUNCTION IF EXISTS Ven_Indicadores(INTEGER) CASCADE;
DROP FUNCTION IF EXISTS Ven_ReporteDocumento(TIMESTAMP, TIMESTAMP, CHAR(1), CHAR(2)) CASCADE;
DROP FUNCTION IF EXISTS Ven_ReporteDocumento_Default(TIMESTAMP, TIMESTAMP, CHAR(1), CHAR(2)) CASCADE;
DROP FUNCTION IF EXISTS Kardex_Consulta(CHAR(4), TIMESTAMP, TIMESTAMP) CASCADE;
DROP FUNCTION IF EXISTS Kardex_Consulta(CHARACTER, TIMESTAMP, TIMESTAMP) CASCADE;
DROP FUNCTION IF EXISTS Stock_Resumen(CHAR(2)) CASCADE;
DROP FUNCTION IF EXISTS Stock_Resumen(CHARACTER) CASCADE;
DROP FUNCTION IF EXISTS Productos_StockCritico() CASCADE;
DROP FUNCTION IF EXISTS Top_Productos_Vendidos(INTEGER) CASCADE;
DROP FUNCTION IF EXISTS Consulta_Stock_Rapido(CHAR(4)) CASCADE;
DROP FUNCTION IF EXISTS Consulta_Stock_Rapido(CHARACTER) CASCADE;
DROP FUNCTION IF EXISTS Valorizacion_Inventario() CASCADE;
DROP FUNCTION IF EXISTS Rotacion_Inventario(INTEGER, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS Kardex_Resumido(CHAR(4), INTEGER, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS Kardex_Resumido(CHARACTER, INTEGER, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS Movimientos_PorFecha(TIMESTAMP, TIMESTAMP, CHAR(1)) CASCADE;
DROP FUNCTION IF EXISTS Movimientos_PorFecha(TIMESTAMP, TIMESTAMP, CHARACTER) CASCADE;
DROP FUNCTION IF EXISTS Registrar_Venta(CHAR(4), CHAR(9), TIMESTAMP, CHAR(2), CHAR(1), TEXT, BOOLEAN, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS Registrar_Compra(CHAR(4), CHAR(9), TIMESTAMP, CHAR(2), TEXT) CASCADE;
